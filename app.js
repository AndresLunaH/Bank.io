...
const card1 = document.querySelector(".login");
...
let usuarios = [
  ...
  function loguear() {
    ...
    const inpUsuario = document.getElementById("username-field").value;
    const inpContrasena = document.getElementById("password").value;
